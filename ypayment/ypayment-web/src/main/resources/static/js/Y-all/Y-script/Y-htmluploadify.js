...
define(function(require, exports, module){
	...
	Y.inherit('HtmlUploadify', 'Window', {
	    doInit: function(cfg){
			...
			if(useType) {
			    content.find('.fn-bottom').html('<span style="color:#999999;font-size:14px;">'+this.strings.type+useType.replace(/\./g,'').replace(/\*|\s/g,'')+"</span>");
			}                   
			if(!cfg.multi){
			...
			if(cfg.addAble){
				var addbtn = $('<span class="base-btn"><span>'+this.strings.add+'</span><span/>');
