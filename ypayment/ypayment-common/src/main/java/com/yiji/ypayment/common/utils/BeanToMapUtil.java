 ...
 * @Author QinXuezhen
 * 
 * @Email qxuezhen@yiji.com
 * 
 * @History <li>Author: QinXuezhen</li> <li>Date: 2012-12-4</li> <li>Version:
...
public class BeanToMapUtil {
	 ...
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static Map<String, String> convertBeanToMap(Object bean) throws IntrospectionException,
