...
/*
 * 修订记录：
 * @author xinqing@yiji.com 下午4:50:04 创建
 */
...
public enum DepositStatusEnum {
	...
	public static java.util.List<DepositStatusEnum> getAllEnum() {
		java.util.List<DepositStatusEnum> list = new java.util.ArrayList<DepositStatusEnum>(values().length);
		for (DepositStatusEnum _enum : values()) {
			list.add(_enum);
		}
		return list;
